...
class PreferencesRepositoryImpl(private val context: Context) : PreferencesRepository {
    ...
    override fun getLastEthanolPrice(): String = sharedPreferences.getString(LAST_ETHANOL, "") ?: ""

    override fun setLastEthanolPrice(price: String) {
        sharedPreferences.edit { putString(LAST_ETHANOL, price) }
    }

    override fun getLastGasolinePrice(): String = sharedPreferences.getString(LAST_GASOLINE, "") ?: ""

    override fun setLastGasolinePrice(price: String) {
        sharedPreferences.edit { putString(LAST_GASOLINE, price) }
    }

    override fun getDeviceId(): String = sharedPreferences.getString(PREF_DEVICE_ID, "") ?: ""

    override fun setDeviceId(deviceId: String) {
        sharedPreferences.edit { putString(PREF_DEVICE_ID, deviceId) }
    }

    override fun getDeviceIdOld(): String = sharedPreferences.getString(PREF_DEVICE_ID_OLD, "") ?: ""

    override fun setDeviceIdOld(deviceId: String) {
        sharedPreferences.edit { putString(PREF_DEVICE_ID_OLD, deviceId) }
    }

    override fun getFcmToken(): String = sharedPreferences.getString(PREF_FCM_TOKEN, "") ?: ""

    override fun setFcmToken(token: String) {
        sharedPreferences.edit { putString(PREF_FCM_TOKEN, token) }
    }

    override fun getShareLink(): String = sharedPreferences.getString(PREF_SHARE_LINK, "") ?: ""

    override fun setShareLink(link: String) {
        sharedPreferences.edit { putString(PREF_SHARE_LINK, link) }
    }

    override fun getAppName(): String = sharedPreferences.getString(PREF_APP_NAME, "") ?: ""

    override fun setAppName(name: String) {
        sharedPreferences.edit { putString(PREF_APP_NAME, name) }
    }

    override fun getNotificationJson(): String? = sharedPreferences.getString(PREF_NOTIFICATION_JSON, null)
