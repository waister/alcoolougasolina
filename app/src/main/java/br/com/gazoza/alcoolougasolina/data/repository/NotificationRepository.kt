...
class NotificationRepositoryImpl(
    ...
    override suspend fun getNotificationDetail(id: String): DataResult<NotificationItem> =
        withContext(Dispatchers.IO) {
            try {
                val cachedJson = preferencesRepository.getNotificationJson()
                if (!cachedJson.isNullOrEmpty() && cachedJson.getValidJSONObject()
    ...
    override suspend fun identifyUser(token: String): DataResult<JSONObject> =
        withContext(Dispatchers.IO) {
            try {
